      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 15,
            child: IconButton(
              icon: Image.asset('assets/backarrow.png', width: 50, height: 50),
                    ...
                    Expanded(
                      child: SingleChildScrollView(
                        child: Padding(
                          ...
                          child: Text(
                            '1. Getting Started:\n'
                                '• Download and install Equilibrease from the App Store or Google Play Store.\n'
                                '• Creating an account should be done by Doctor.\n'
                                ...
                                '  • Seeing Record a new vertigo episode:\n'
