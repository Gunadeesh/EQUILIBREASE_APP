...
class _PatientCommentsScreenState extends State<PatientCommentsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFC5EDFE), // Total background color
      appBar: AppBar(
        backgroundColor: const Color(0xFFC5EDFE),
        elevation: 0,
        leading: Padding(
          padding: const EdgeInsets.only(top: 15.0), // Add padding to move the back button down
          child: IconButton(
            icon: Image.asset('assets/backarrow.png', width: 50, height: 34),
