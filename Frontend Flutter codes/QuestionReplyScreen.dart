  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xFFC5EDFE),
        leading: Padding(
          padding: EdgeInsets.only(top: 10), // You can adjust the padding value as needed
          child: IconButton(
        ...
        children: [
          Padding(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Text("Patient's Comments", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  SizedBox(height: 5),
                ],
              ),
            ),
