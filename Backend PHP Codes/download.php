...
// Use a SQL query to fetch all rows from the 'patients' table
$query = "SELECT name,age,sex,patientId,password,occupation,diagnosis,comorbidities,investigations,examination,medications FROM patients";
