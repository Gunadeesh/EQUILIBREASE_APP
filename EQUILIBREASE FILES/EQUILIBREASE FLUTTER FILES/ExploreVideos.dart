...
class _ExploreVideosState extends State<ExploreVideos> {
  ...
  List<Video> videos = [
    ...
    Video(
      ...
      imagePath: 'assets/Thirteenth.png',
      languages: ['English', 'Telugu', 'Hindi', 'Tamil'],
      uris: {
