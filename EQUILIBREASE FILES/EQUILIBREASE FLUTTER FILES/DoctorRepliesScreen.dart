      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              _buildHeader(),
              SizedBox(height: 20), // Add space between header and replies
  ...
  Widget _buildHeader() {
    return Column(
      children: [
        ...
        SizedBox(height: 5), // Space between the back arrow and the title
        // Doctor Replies container centered below the back arrow
        Container(
